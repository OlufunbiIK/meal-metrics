  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50">
        {/* Backdrop */}
        <div
          className="absolute inset-0 bg-black/30 backdrop-blur-[100%]
    transition-opacity"
          onClick={onClose}
        />
        ...
        >
          <div className="flex h-full">
            {/* Left Sidebar */}
            <div className="w-48 border-r border-gray-200 flex flex-col items-center py-6">
              {/* Close Button */}
              <button
                onClick={onClose}
            ...
            <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl transform transition-transform duration-300 ease-out flex flex-col">
              <div className="flex items-center justify-between p-4">
                <h2 className="text-lg px-3 font-semibold text-gray-900">
                  Add Item
                </h2>
              </div>

              {/* Form Content */}
              <div className="flex-1 overflow-y-auto p-4 space-y-6 mx-6 rounded-lg bg-[#F2F2F2]">
                {/* Item Information */}
